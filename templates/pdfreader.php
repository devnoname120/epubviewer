...
<head class="session" data-nonce='<?php p($nonce); ?>' data-downloadlink='<?php print_unescaped($downloadLink); ?>'
  ...
  <link rel="stylesheet"
        href="<?php p($urlGenerator->linkTo('epubviewer', 'js/icomoon/style.css')) ?>?v=<?php p($version) ?>">
  <link rel="stylesheet"
        href="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/css/main.css')) ?>?v=<?php p($version) ?>">
  <link rel="stylesheet"
        href="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/css/sidebar.css')) ?>?v=<?php p($version) ?>">
  <link rel="stylesheet"
        href="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/css/text_layer_builder.css')) ?>?v=<?php p($version) ?>">
  <link rel="stylesheet"
        href="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/css/annotation_layer_builder.css')) ?>?v=<?php p($version) ?>">
  ...
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/services/eventbus_service.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/services/link_service.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/services/simple_link_service.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/progress_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/textlayer_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/search_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/reader_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/sidebar_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/settings_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/controls_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/toc_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/outline_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/annotationlayer_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/notes_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/bookmarks_controller.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/controllers/styles_controller.js')) ?>?v=<?php p($version) ?>"></script>
    <?php if ($idevice): ?>
      <link rel="stylesheet"
            href="<?php p($urlGenerator->linkTo('epubviewer', 'js/pdfjs/css/idevice.css')) ?>?v=<?php p($version) ?>">
      <script type="text/javascript" nonce="<?php p($nonce) ?>"
              src="<?php p($urlGenerator->linkTo('epubviewer', 'js/bgrins/spectrum.js')) ?>?v=<?php p($version) ?>"></script>
      <link rel="stylesheet"
            href="<?php p($urlGenerator->linkTo('epubviewer', 'js/bgrins/spectrum.css')) ?>?v=<?php p($version) ?>">
    <?php endif; ?>

  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/epubviewer-ready.mjs')) ?>?v=<?php p($version) ?>"></script>
</head>
<body>
<div id="outerContainer">
  ...
  <div id="progress" class="hide">
    ...
    <br>
    <div class="message"><span class="message-icons"><span id="download_icon" class="icon-cloud_download"></span></span>
  ...
  <div id="sidebar" class="sidebar">
    <div id="panels" class="panels">
      <div class="pull-left">
        ...
        <button id="show-Outline" class="show_view icon-format_list_numbered" title="Outline"
                data-view="Outline"></button>
        <!-- currently not used
    ...
    <div id="titlebar">
      ...
      <div id="title-controls">
        ...
        <div id="zoom_options" class="hide">
          <div class="zoom_option icon-double_page_mode" data-value="spread" data-class="icon-double_page_mode"
               data-text=""></div>
          <div class="zoom_option icon-single_page_mode" data-value="fit_page" data-class="icon-single_page_mode"
               data-text=""></div>
          <div class="zoom_option icon-icon-fit-width" data-value="fit_width" data-class="icon-icon-fit-width"
               data-text=""></div>
