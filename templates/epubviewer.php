...
<head class="session" data-nonce='<?php p($nonce); ?>' data-downloadlink='<?php print_unescaped($downloadLink); ?>'
  ...
  <link rel="stylesheet"
        href="<?php p($urlGenerator->linkTo('epubviewer', 'js/epubjs/css/main.css')) ?>?v=<?php p($version) ?>">
  <link rel="stylesheet"
        href="<?php p($urlGenerator->linkTo('epubviewer', 'js/epubjs/css/sidebar.css')) ?>?v=<?php p($version) ?>">
  <link rel="stylesheet"
        href="<?php p($urlGenerator->linkTo('epubviewer', 'js/epubjs/css/popup.css')) ?>?v=<?php p($version) ?>">
  ...
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/epubjs/libs/zip.min.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/epubjs/epub.min.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/epubjs/hooks.min.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/epubjs/hooks/extensions/highlight.js')) ?>?v=<?php p($version) ?>"></script>
  <script type="text/javascript" nonce="<?php p($nonce) ?>"
          src="<?php p($urlGenerator->linkTo('epubviewer', 'js/epubjs/reader.min.js')) ?>?v=<?php p($version) ?>"></script>

    <?php if ($idevice): ?>
      <link rel="stylesheet"
            href="<?php p($urlGenerator->linkTo('epubviewer', 'js/epubjs/css/idevice.css')) ?>?v=<?php p($version) ?>">
      <script type="text/javascript" nonce="<?php p($nonce) ?>"
...
<div id="outerContainer">
  ...
  <div id="sidebar" class="sidebar">
    <div id="panels" class="panels">
      <div class="pull-left">
        <button id="show-Toc" class="show_view icon-format_list_numbered open" title="Table of Contents"
                data-view="Toc"></button>
        ...
        <div>
          <div class="notes-input">
            <textarea id="note-text" class="note-text"
                      placeholder="Write note, press 'marker' button and select position in text to link note."></textarea>
